 ...
 */
public class MyDBSaver extends AbstractSaver implements BatchConverter,
   ...
   */
  public MyDBSaver() throws Exception {
  ...
  private void writeStructure() throws Exception {
    ...
    if (m_DataBaseConnection.tableExists(m_resolvedTableName)) {
      ...
      //System.out.println("trincando tabla..." + trunc);
  ...
  public void writeBatch() throws IOException {
    ...
    try {
      ...
      setWriteMode(WRITE);
      System.out.println("building header table...");
      writeStructure();
      System.out.println("building content table...");
      int aux =0;
      for (int i = 0; i < instances.numInstances(); i++) {
        writeInstance(instances.instance(i));
        aux++;
      }
      System.out.println("instancias: "+aux);
