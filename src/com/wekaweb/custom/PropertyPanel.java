...
public class PropertyPanel extends JPanel {
  ...
  protected void createDefaultPanel() {
    ...
    setToolTipText("click izquierdo Left-click to edit properties for this object, right-click/Alt+Shift+left-click for menu");
    setOpaque(true);
        ...
        if (evt.getClickCount() == 1) {
          if ((evt.getButton() == MouseEvent.BUTTON1) && !evt.isAltDown()
            ...
            if (m_Editor.getValue() != null) {
              item = new JMenuItem("mostrar propiedades...");
