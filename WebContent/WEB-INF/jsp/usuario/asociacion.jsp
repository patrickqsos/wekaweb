...
<html lang="en">
  <head>
    ...
    <title>Asociacion de datos</title>
    ...
    <script type="text/javascript">
    	...
    	var tree = [
    	            ...
    	            nodes: [
    	            	...
    	            	{
    	            		text: "FilteredAssociator",
    	            		className: "weka.associations.FilteredAssociator",
    	            	},
    	            	{
    	            		text: "FPGrowth",
    	            		className: "weka.associations.FPGrowth",
    	            	}
    	            ]
	...
	<div class="container">
		...
		<div class="page-header">
	  	...
	  	<ol class="breadcrumb hidden-print">
			<li><a href="<%=request.getContextPath()%>/Main?action=index">Home</a></li>
			<li>Datasets</li>
			<li class="active"><a href="<%=request.getContextPath()%>/Main?action=asociacion">Asociacion</a></li>
	  	</ol>
