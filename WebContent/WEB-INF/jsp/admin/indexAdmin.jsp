<%@ page language="java" contentType="text/html; charset=ISO-8859-1"
    ...
    <%@ page import="com.wekaweb.beans.UsuarioBean"%>
...
<div id="templatemo_wrapper">
	...
	<div id="templatemo_menu">
        ...
        <ul>
            <li><a href="indexAdmin.jsp" class="current">Home</a></li>
            ...
            <li><a href="<%=request.getContextPath()%>/Logout"><jsp:getProperty property="email" name="usuario"/> Logout</a></li>
        </ul>    	
    ...
    <div id="templatemo_middle">
		...
		<div id="mid_title">index admin</div>
            
        <p>
        	El presente proyecto académico está orientado a desarrollar una interface para el uso de la herramienta Weka, en un entorno Cloud Computing basado en el modelo SaaS.
    ...
    <div id="templatemo_fp_services">
		...
		<div class="fp_services_box">
            <div class="fps_title"><a href="#">Cloud Computing</a></div>
            <p>Descripcion corta de cloud computing.</p>
            <a href="#" class="sb_more">Mas</a>
     	</div>
        
        <div class="fp_services_box">
            <div class="fps_title"><a href="#">Mineria de datos</a></div>
            <p>Descripcion corta de mineria de datos.</p>
            <a href="#" class="sb_more">Mas</a>
        </div>
        
        <div class="fp_services_box l_box">
            <div class="fps_title"><a href="#">Weka</a></div>
            <p>Descripcion corta de la herramienta weka.</p>
            <a href="#" class="sb_more">Mas</a>
        </div>
