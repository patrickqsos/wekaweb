...
<html lang="en">
  <head>
    ...
    <script src="js/wekaweb/editPublic.js"></script>
  </head>
      ...
      <div class="container">
        ...
        <div class="navbar-collapse collapse">
          <ul class="nav navbar-nav">
            <!--  
            <li><a href="/invitado?action=index">Home</a></li>
            -->
            <li class="dropdown">
	...
	<div class="container">
		...
		<div class="page-header">
	  	...
	  	<ol class="breadcrumb hidden-print">
			...
			<li class="active"><a href="<%=request.getContextPath()%>/invitado?action=editar">Editar dataset</a></li>
	  	</ol>
        		...
        		<div class="panel-group" id="datasetList">
					<c:choose>
					      <c:when test="${empty datasetsu}">
					      	<div class="alert alert-warning" role="alert">Parece que no hay ningun dataset publico. Registrate y podras importar y trabajar con tus propios datos!</div>
					      </c:when>
					      <c:otherwise>
